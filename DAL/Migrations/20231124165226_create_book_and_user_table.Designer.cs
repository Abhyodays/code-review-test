...
namespace DAL.Migrations
{
    ...
    [Migration("20231124165226_create_book_and_user_table")]
    partial class create_book_and_user_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Book", b =>
                {
                    b.HasOne("Domain.Models.ApplicationUser", "BorrowedByUser")
                        .WithMany("BooksBorrowed")
                        .HasForeignKey("BorrowedByUserId");

                    b.HasOne("Domain.Models.ApplicationUser", "LentByUser")
                        .WithMany("BooksLented")
